...
const productItems = [
        {
            name: "Комп'ютери",
            img: "images/computer/computers1.png",
            products: [
                {
            ...
            {
            name: "Смартфони",
            img: "images/smartphone/smartphone.png",
            products:  [
                {
                    img: "images/smartphone/apple12.jfif",
                    name: "Мобільний телефон Apple iPhone 12 64GB Blue",
                ...
                },
                {
                    ...
                    name: "Мобільний телефон Apple iPhone 13 256GB Blue",
                    description: "Диагональ экрана\n" +
                        "6.1\n" +
                        "Встроенная память\n" +
                        "64 ГБ\n" +
                ...
                },
                {
                    ...
                    name: "Мобильный телефон Apple iPhone 14 128GB Starlight",
                    description: "Диагональ экрана\n" +
                        "6.1\n" +
                        "Встроенная память\n" +
                        "64 ГБ\n" +
                ...
                },
                {
                    ...
                    name: "Мобильный телефон Samsung Galaxy M23 5G",
                    description: "Диагональ экрана\n" +
                        "6.1\n" +
                        "Встроенная память\n" +
                        "64 ГБ\n" +
                ...
                },
                {
                    ...
                    name: "Мобильный телефон Samsung Galaxy M53",
                    description: "Диагональ экрана\n" +
                        "6.1\n" +
                        "Встроенная память\n" +
                        "64 ГБ\n" +
                ...
                },
                {
                    ...
                    name: "Мобильный телефон Samsung Galaxy M13",
                    description: "Диагональ экрана\n" +
                        "6.1\n" +
                        "Встроенная память\n" +
                        "64 ГБ\n" +
